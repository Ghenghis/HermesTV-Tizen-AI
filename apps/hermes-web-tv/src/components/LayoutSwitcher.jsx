    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <div id="look-modal-title" style={{ fontSize: 'calc(1.2rem * var(--font-scale, 1))', fontWeight: 700, color: '#e8edf5' }}>Choose Your Look</div>
          ...
          <button
            ...
            onBlur={function(e) { e.currentTarget.style.color = '#8a8f9b'; e.currentTarget.style.outline = 'none'; }}
          >
            &times;
          </button>
        </div>
                    ...
                    return (
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
                          ...
                          {isDisabled && (
                            <span style={{ fontSize: 'calc(0.6rem * var(--font-scale, 1))', color: '#8a8f9b', border: '1px solid #2a2b3a', borderRadius: '3px', padding: '1px 5px' }}>
                              QN85 only
                            </span>
                          )}
                        </div>
